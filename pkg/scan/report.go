    ...
    <div class="row parent">
      <div class="col-md-3" id="left">
        <div id="rules" class="text-center">
          <br/>
          <h3><span style="font-weight: bold; font-size: 40px;" id="rule-count">{{ len .Scanner.RuleSet.Rules }}</span> active rule(s)</h3>
          <p>Defined by {{ .Scanner.RulesPath }}<br/>last read on {{ .Scanner.RuleSet.ReadAt | date "2006-01-02 15:04:05" }}</p>
            ...
            <div id="container-{{ sha1sum .Definition }}">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">Size: {{ .Size }} bits</p>
